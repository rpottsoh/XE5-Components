...
type
  ...
  published
    ...
    property OnCollapse : TNotifyEvent read FCollapseClicked write FCollapseClicked;
  end;
...
begin
  ...
  if assigned(FCollapseClicked) then
    FCollapseClicked(self);
end;
