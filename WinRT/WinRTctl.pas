...
const
    ...
    IOCTL_WINRT_PROCESS_BUFFER              = (Longword(WINRT_DEVICE_TYPE) shl 16)
                                              or (FILE_ANY_ACCESS shl 14)
                                              or ($800 shl 2) or METHOD_BUFFERED;
    IOCTL_WINRT_PROCESS_BUFFER_DIRECT       = (Longword(WINRT_DEVICE_TYPE) shl 16)
                                              or (FILE_ANY_ACCESS shl 14)
                                              or ($801 shl 2) or METHOD_IN_DIRECT;
    IOCTL_WINRT_PROCESS_DMA_BUFFER          = (Longword(WINRT_DEVICE_TYPE) shl 16)
                                              or (FILE_ANY_ACCESS shl 14)
                                              or ($802 shl 2) or METHOD_BUFFERED;
    IOCTL_WINRT_PROCESS_DMA_BUFFER_DIRECT   = (Longword(WINRT_DEVICE_TYPE) shl 16)
                                              or (FILE_ANY_ACCESS shl 14)
                                              or ($803 shl 2) or METHOD_IN_DIRECT;
    IOCTL_WINRT_GET_CONFIG                  = (Longword(WINRT_DEVICE_TYPE) shl 16)
                                              or (FILE_ANY_ACCESS shl 14)
                                              or ($804 shl 2) or METHOD_BUFFERED;
    IOCTL_WINRT_MAP_MEMORY                  = (Longword(WINRT_DEVICE_TYPE) shl 16)
                                              or (FILE_ANY_ACCESS shl 14)
                                              or ($806 shl 2) or METHOD_BUFFERED;
    IOCTL_WINRT_UNMAP_MEMORY                = (Longword(WINRT_DEVICE_TYPE) shl 16)
                                              or (FILE_ANY_ACCESS shl 14)
                                              or ($807 shl 2) or METHOD_BUFFERED;
    IOCTL_WINRT_AUTOINC_IO                  = (Longword(WINRT_DEVICE_TYPE) shl 16)
                                              or (FILE_ANY_ACCESS shl 14)
                                              or ($808 shl 2) or METHOD_BUFFERED;
    IOCTL_WINRT_WAIT_INTERRUPT              = (Longword(WINRT_DEVICE_TYPE) shl 16)
                                              or (FILE_ANY_ACCESS shl 14)
                                              or ($809 shl 2) or METHOD_BUFFERED;
    IOCTL_WINRT_SET_INTERRUPT               = (Longword(WINRT_DEVICE_TYPE) shl 16)
                                              or (FILE_ANY_ACCESS shl 14)
                                              or ($80A shl 2) or METHOD_IN_DIRECT;
    IOCTL_WINRT_SET_TIMER                   = (Longword(WINRT_DEVICE_TYPE) shl 16)
                                              or (FILE_ANY_ACCESS shl 14)
                                              or ($80B shl 2) or METHOD_IN_DIRECT;
    IOCTL_WINRT_SETUP_DMA_BUFFER            = (Longword(WINRT_DEVICE_TYPE) shl 16)
                                              or (FILE_ANY_ACCESS shl 14)
                                              or ($80C shl 2) or METHOD_BUFFERED;
    IOCTL_WINRT_FREE_DMA_BUFFER             = (Longword(WINRT_DEVICE_TYPE) shl 16)
                                              or (FILE_ANY_ACCESS shl 14)
